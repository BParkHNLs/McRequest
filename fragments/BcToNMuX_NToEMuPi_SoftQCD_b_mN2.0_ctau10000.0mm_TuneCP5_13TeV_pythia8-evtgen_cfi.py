...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('McRequest/evtGenData/evt_2014_mass2.0_ctau10000.0_maj.pdl'),
            user_decay_file = cms.vstring('McRequest/evtGenData/HNLdecay_mass2.0_maj_emu_Bc.DEC'),
        ),
