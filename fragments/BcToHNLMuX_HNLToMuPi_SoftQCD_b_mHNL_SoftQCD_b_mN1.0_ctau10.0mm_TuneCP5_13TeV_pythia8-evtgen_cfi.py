...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Bc -> mu N X, with long-lived N, m=1.0GeV, ctau=10.0mm'),
    name = cms.untracked.string('Bc -> mu N X, with long-lived N, m=1.0GeV, ctau=10.0mm'),
