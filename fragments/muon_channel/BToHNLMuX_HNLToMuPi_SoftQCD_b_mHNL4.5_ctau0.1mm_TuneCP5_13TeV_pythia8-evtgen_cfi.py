...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> mu N X, with long-lived N, m=4.5GeV, ctau=0.1mm'),
    name = cms.untracked.string('B -> mu N X, with long-lived N, m=4.5GeV, ctau=0.1mm'),
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass4.5_ctau0.1_maj.pdl'),
            user_decay_embedded = cms.vstring(
               ...
               'Decay myB+',
               '0.0628174776               mu+    hnl    PHSP;',
               '0.0000000000    anti-D0    mu+    hnl    PHSP;',
               '0.0000000000    anti-D*0   mu+    hnl    PHSP;',
               '0.0007489423    pi0        mu+    hnl    PHSP;',
               '0.0000000000    rho0       mu+    hnl    PHSP;',
               'Enddecay',
               'CDecay myB-',
               'Decay myB0',
               '0.0000000000    D-    mu+    hnl    PHSP;',
               '0.0000000000    D*-   mu+    hnl    PHSP;',
               '0.0013690040    pi-   mu+    hnl    PHSP;',
               '0.0000000000   rho-   mu+    hnl    PHSP;',
               'Enddecay',
               'CDecay myB0bar',
               'Decay myB0s',
               '0.0000000000    D_s-    mu+    hnl    PHSP;',
               '0.0000000000    D_s*-   mu+    hnl    PHSP;',
               '0.0002692529    K-      mu+    hnl    PHSP;',
               '0.0000000000    K*-     mu+    hnl    PHSP;',
               'Enddecay',
               'CDecay myB0sbar',
               'Decay hnl',
               '0.5     mu-    pi+    PHSP;',
