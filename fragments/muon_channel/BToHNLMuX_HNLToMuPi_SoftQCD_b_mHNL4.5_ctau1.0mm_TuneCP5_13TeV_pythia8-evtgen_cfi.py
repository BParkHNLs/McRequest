...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> mu N X, with long-lived N, m=4.5GeV, ctau=1.0mm'),
    name = cms.untracked.string('B -> mu N X, with long-lived N, m=4.5GeV, ctau=1.0mm'),
