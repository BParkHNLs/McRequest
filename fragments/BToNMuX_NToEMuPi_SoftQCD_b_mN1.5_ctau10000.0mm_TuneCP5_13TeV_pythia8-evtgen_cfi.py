...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> mu N X, with long-lived N, m=1.5GeV, ctau=10000.0mm'),
    name = cms.untracked.string('B -> mu N X, with long-lived N, m=1.5GeV, ctau=10000.0mm'),
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass1.5_ctau10000.0_maj.pdl'),
            user_decay_file = cms.vstring('GeneratorInterface/EvtGenInterface/data/HNLdecay_mass1.5_maj_emu.DEC'),
        ),
