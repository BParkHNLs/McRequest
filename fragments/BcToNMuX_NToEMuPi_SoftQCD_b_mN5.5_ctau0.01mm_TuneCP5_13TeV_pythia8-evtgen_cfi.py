...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Bc -> mu N X, with long-lived N, m=5.5GeV, ctau=0.01mm'),
    name = cms.untracked.string('Bc -> mu N X, with long-lived N, m=5.5GeV, ctau=0.01mm'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('McRequest/evtGenData/evt_2014_mass5.5_ctau0.01_maj.pdl'),
