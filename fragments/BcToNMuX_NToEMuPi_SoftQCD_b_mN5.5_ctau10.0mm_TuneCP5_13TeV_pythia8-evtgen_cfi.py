...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('McRequest/evtGenData/evt_BHNL_mass5.5_ctau10.0_maj.pdl'),
            user_decay_file = cms.vstring('McRequest/evtGenData/HNLdecay_mass5.5_maj_emu_Bc.DEC'),
        ),
