...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> mu N X, with long-lived N, m=3.0GeV, ctau=100.0mm'),
    name = cms.untracked.string('B -> mu N X, with long-lived N, m=3.0GeV, ctau=100.0mm'),
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/EvtGenInterface/data/HNLdecay_mass3.0_maj_emu.DEC'),
        ),
