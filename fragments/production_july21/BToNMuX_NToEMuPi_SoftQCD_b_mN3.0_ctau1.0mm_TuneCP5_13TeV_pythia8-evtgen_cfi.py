...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> mu N X, with long-lived N, m=3.0GeV, ctau=1.0mm'),
    name = cms.untracked.string('B -> mu N X, with long-lived N, m=3.0GeV, ctau=1.0mm'),
