...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Bc -> mu N X, with long-lived N, m=4.5GeV, ctau=10.0mm'),
    name = cms.untracked.string('Bc -> mu N X, with long-lived N, m=4.5GeV, ctau=10.0mm'),
...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('McRequest/evtGenData/evt_BHNL_mass4.5_ctau10.0_maj.pdl'),
            user_decay_file = cms.vstring('McRequest/evtGenData/HNLdecay_mass4.5_maj_emu_Bc.DEC'),
        ),
