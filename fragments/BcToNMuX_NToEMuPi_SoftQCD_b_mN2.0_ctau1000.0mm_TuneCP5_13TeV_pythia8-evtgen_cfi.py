...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Bc -> mu N X, with long-lived N, m=2.0GeV, ctau=1000.0mm'),
    name = cms.untracked.string('Bc -> mu N X, with long-lived N, m=2.0GeV, ctau=1000.0mm'),
...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('McRequest/evtGenData/evt_2014_mass2.0_ctau1000.0_maj.pdl'),
